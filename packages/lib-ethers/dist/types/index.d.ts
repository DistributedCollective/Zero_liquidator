...
export interface CommunityIssuance extends _TypedLiquityContract<CommunityIssuanceCalls, CommunityIssuanceTransactions> {
    ...
    extractEvents(logs: Log[], name: "CommunityPotAddressSet"): _TypedLogDescription<{
        _communityPotAddress: string;
    }>[];
    extractEvents(logs: Log[], name: "FundingWalletAddressSet"): _TypedLogDescription<{
    ...
    extractEvents(logs: Log[], name: "TotalZEROIssuedUpdated"): _TypedLogDescription<{
        _fundingWalletAddress: BigNumber;
    }>[];
...
export interface StabilityPool extends _TypedLiquityContract<StabilityPoolCalls, StabilityPoolTransactions> {
    ...
    extractEvents(logs: Log[], name: "ZEROPaidToDepositor"): _TypedLogDescription<{
        _depositor: string;
        _ZERO: BigNumber;
    }>[];
    extractEvents(logs: Log[], name: "ZEROPaidToFrontEnd"): _TypedLogDescription<{
        _frontEnd: string;
        _ZERO: BigNumber;
    }>[];
    extractEvents(logs: Log[], name: "ZUSDTokenAddressChanged"): _TypedLogDescription<{
...
export interface MockBalanceRedirectPresale extends _TypedLiquityContract<MockBalanceRedirectPresaleCalls, MockBalanceRedirectPresaleTransactions> {
    readonly address: string;
    readonly filters: {};
}
...
export interface FeeDistributor extends _TypedLiquityContract<FeeDistributorCalls, FeeDistributorTransactions> {
    ...
    extractEvents(logs: Log[], name: "SOVFeeCollectorAddressChanged"): _TypedLogDescription<{
        _sovFeeCollectorAddress: string;
    }>[];
    extractEvents(logs: Log[], name: "TroveManagerAddressChanged"): _TypedLogDescription<{
        _troveManagerAddress: string;
    }>[];
